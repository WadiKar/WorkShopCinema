...
#
#
# # test_add_cinema – sprawdzający, czy dodawanie nowego kina działa.
# @pytest.mark.django_db
# def test_get_cinema_list(client, set_up):
#     cinema = Cinema.objects.first()
#
#
# # test_get_cinema_list – sprawdzający, czy działa lista wszystkich kin.
# @pytest.mark.django_db
# def test_get_cinema_detail(client, set_up):
#     cinema = Cinema.objects.first()
#
#
# # test_get_cinema_detail – sprawdzający, czy szczegółowy widok kina działa.
# @pytest.mark.django_db
# def test_delete_cinema(client, set_up):
#     cinema = Cinema.objects.first()
#
#
# # test_delete_cinema – sprawdzający usuwanie kina.
# @pytest.mark.django_db
# def test_update_cinema(client, set_up):
#     cinema = Cinema.objects.first()
# # test_update_cinema – sprawdzający, czy aktualizacja kina działa.
import pytest
import pytz
